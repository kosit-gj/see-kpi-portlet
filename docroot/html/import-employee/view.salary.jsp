...
<div id="container1">
	...
	<div class="row-fluid app_url_hidden">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title"> <h5> Advance Search </h5> </div>
						...
						<div class="form-group pull-right m-b-none ">
							<div class="form-group pull-right m-b-none ">
								...
								<button id="btn_assign_level" type="submit" data-toggle="modal"
									...
									<i class="fa fa-pencil-square-o"></i>&nbsp;Assign&nbsp;Level
								</button>
							</div>
							<div class="form-group pull-right m-b-none ">
	...
	<div class="row-fluid " id="employee_list_content">
		<div class="col-lg-12">
			<div class="ibox-title"> <h5>Employee List</h5> </div>
					...
					<table class="table table-striped" id="tableEmployee" style="max-width: none;">
						<thead>
							<tr style="white-space:nowrap">
								...
								<th> Position Name </th>
								<th> Chief Emp Code </th>
								<th> Appraisal Level </th>
								<th style='text-align:center' class='objectCenter'> Manage </th>
							</tr>
						</thead>
				...
				<div class="form-inline p-b-xs" id="txtAssignEmpName">
					<div class="form-group">
						<div class="form-group m-n ">
							<label class="form-label-emp">Employee Name: </label> &nbsp;
