                ...
                <div class="row-fluid" id='advanceSearchAppraisal'>
				 ...
				 <div class="form-group pull-left span3" style="margin-left: 5px">
                  ...
                  <div class="form-group span3 m-b-none pull-right" style="margin-top: 1px; margin-left: 5px; margin-right: 3px; text-align:right;">
                    ...
                    &nbsp;
                    <form id="formCalculation" action="" method="post" class="pull-right" style="margin-bottom: 0px; margin-left: 5px">
						<button type="button" class="btn btn-warning input-sm" name="btnCalculation" id="btnCalculation">
