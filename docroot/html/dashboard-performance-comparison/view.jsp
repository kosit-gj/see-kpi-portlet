  ...
  <div class="app_url_hidden row-fluid">
                ...
                <div class="row-fluid" id='advanceSearchAppraisal'>
                 ...
                 <!--  <div class="form-group pull-left span3" style="margin-left: 5px">
                  ...
                  <div class="form-group pull-left span3" style="margin-left: 5px">
                   ...
                   <div class="form-group pull-left span3" style="margin-left: 5px">
                    <select data-toggle="tooltip" title="" data-original-title="<liferay-ui:message key="position"/>" class="input form-control input-sm span12" id="Position" name="Position">
                    </select>
   ...
   <div  class="ibox-content" id="showChart" style="display:none">
    <div class="row-fluid" style="padding-top: 10px;">
    	<div class="span6"> 
    	<h4 style="text-align: center; font-weight: bold;"><liferay-ui:message key="performance-by-year"/></h4>
	      ...
	      <div class="span6">
		      <h4 style="text-align: center; font-weight: bold;  margin-bottom: 5px;" id="head-bar" ><liferay-ui:message key="performance-by-employee"/> :</h4>
		      <div class="body-chart" style="display:none">
			      <input class="form-control input-sm" id="head-bar-input" name="head-bar-input" value="" type="hidden">
			      <p style="text-align: right; margin-bottom: 0px; font-size:13px; font-weight: bold;"><liferay-ui:message key="percent-change"/>&nbsp;</p>
