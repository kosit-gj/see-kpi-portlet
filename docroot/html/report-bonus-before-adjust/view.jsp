...
<%
	...
	*/
	...
	String param_item_result_id = PortalUtil.getOriginalServletRequest(request)
			.getParameter("param_item_result_id");
...
<input type="hidden" id="param_link" name="param_link"
	value="<%=param_link%>">
<input type="hidden" id="param_item_result_id"
	name="param_item_result_id" value="<%=param_item_result_id%>">

<input type="hidden" id="user_portlet" name="user_portlet"
	value="<%=username%>">
<input type="hidden" id="pass_portlet" name="pass_portlet"
	value="<%=password%>">
<input type="hidden" id="user_locale" name="user_locale"
	value="<%=currentLocale%>">
									...
									<div class="row-fluid">
										...
										<div class="form-group pull-left span3"
											...
											<select data-toggle="tooltip"
												title="<liferay-ui:message key="organization"/>"
												multiple="multiple"
