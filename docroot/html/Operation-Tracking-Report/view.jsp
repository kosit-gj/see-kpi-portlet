              ...
              <div class="ibox-content breadcrumbs2">
                ...
                <div class="row-fluid" id='advanceSearchAppraisal'>
                  ...
                  <div class="form-group pull-left span3" style="margin-left: 5px">
                   	<input class="input form-control input-sm span12" placeholder="<liferay-ui:message key="date-start"/>" data-toggle="tooltip" title="" data-original-title="<liferay-ui:message key="date-start"/>" type="text" id="date-start">
                  </div>
                  
                  <div class="form-group pull-left span3" style="margin-left: 5px">
                   	<input class="input form-control input-sm span12"  placeholder="<liferay-ui:message key="date-end"/>" data-toggle="tooltip" title="" data-original-title="<liferay-ui:message key="date-end"/>" type="text" id="date-end">
                  </div>
