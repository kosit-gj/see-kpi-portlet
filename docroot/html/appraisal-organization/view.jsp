					...
					<div class="row-fluid">
						<div class="table-responsive p-t-xs" style="overflow: auto;">
							<table class="table table-striped" id="tableOrganization">
								<thead>
									<tr>
										<th style='width: auto'>Organization&nbsp;Code</th>
										<th style='width: auto'>Organization</th>
										<th style='width: auto; '>Parent&nbsp;Org.</th>
...
<!-- Modal Start Edit -->
<div aria-hidden="true" role="dialog" tabindex="-1" id="ModalOrganization" class="modal inmodal" style="display: none;">
    ...
    <div class="modal-content  bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalTitleOrganization">Organization</h4>
                <!-- 
                	...
                	<div class="span12 form-horizontal p-t-xxs">
						...
						<div class="form-group p-xxs">
							<label class="control-label">Organization Name:</label>
								<div class="controls">
									<input type="text" class="form-control input-sm span12" placeholder="" id="mOrgName"/>
								</div>
	...
	<div class="modal-dialog">
		<div class="modal-content  bounceInRight">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="">Import Organization</h4>
			</div>
			<div class="modal-body">
				<!-- content start -->
				...
				<div class="form-group">
					<form id="fileImportOrganization">
			...
			<div class="modal-footer">
				<button class="btn btn-success" type="submit"
					id="importOrganization" form="fileImportOrganization">Import</button>
