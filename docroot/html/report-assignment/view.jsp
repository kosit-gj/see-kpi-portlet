            ...
            <div class="ibox float-e-margins">
              ...
              <div class="ibox-content breadcrumbs2">
				...
				<div style="Display:none">
                  ...
                  <div class="form-group pull-left span3" style="margin-left: 5px">
                    <select data-toggle="tooltip" title="<liferay-ui:message key="organization"/>" multiple="multiple" data-original-title="organization" class="input form-control input-sm span12" id="organization" name="organization">
                    </select>
                  </div>
