		...
		<div class="span12">
			...
			<div class="ibox-content">
				<div class="row-fluid" id="sysconf">
					...
					<div class="row-fluid">
						<div class="span12">
						<button type="button" class="btn btn-success" id="btnAddKPI" data-target="#ModalKPI" data-toggle="modal" >
							<i class="fa fa-plus-square"></i>&nbsp;Add KPI Type
						</button>
					</div>
					...
					<div class="row-fluid">
						<div class="table-responsive p-t-xs" style="overflow: auto;">
							<table class="table table-striped" id="tableKPI">
								<thead>
									<tr>
										<th style='width: auto'>KPI&nbsp;Type&nbsp;Name</th>
								...
								<tbody id="listKPI">
									<tr>
										...
										<td id="objectCenter" style="vertical-align: middle;"><i class="fa fa-cog font-gear popover-edit-del" data-html="true" data-toggle="popover" data-placement="top" data-trigger="focus" tabindex="1" data-content="&lt;button class='btn btn-warning btn-xs edit' id=960 data-target=#ModalKPI data-toggle='modal'&gt;Edit&lt;/button&gt;&nbsp;&lt;button id=960 data-target=#confrimModal class='btn btn-danger btn-xs del'&gt;Delete&lt;/button&gt;" data-original-title="" title=""></i></td>
									<tr>
								</tbody>
							</table>
...
<!-- Modal Start Edit -->
<div aria-hidden="true" role="dialog" tabindex="-1" id="ModalKPI" class="modal inmodal" style="display: none;">
    ...
    <div class="modal-content  bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalTitleKPI">KPI Type</h4>
                <!-- 
                	...
                	<div class="span12 form-horizontal p-t-xxs">
						...
						<div class="form-group p-xxs">
							<label class="control-label">KPI Name:</label>
								<div class="controls">
									<input type="text" class="form-control input-sm span12" placeholder="" id="mKPIName"/>
								</div>
            ...
            <div class="modal-footer">
                ...
                <div class="alert alert-warning information" id="information" style="display: none;max-height:45px; overflow-y: scroll; KPI:relative;"></div>
            </div>
        </div>
    </div>
</div>
