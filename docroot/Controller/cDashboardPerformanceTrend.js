...
var generateSubTableKPIFn = function(item,data){
	...
	ContentHTML+="	<thead>";
	ContentHTML+="		<tr>";
	ContentHTML+="			<th><div class='fontBold ' style='width:100px'>"+Liferay.Language.get('target')+"</div></th>";
	ContentHTML+="			<th><div class='fontBold ' style='width:100px'>"+Liferay.Language.get('forecast')+"</div></th>";
	ContentHTML+="			<th><div class='fontBold ' style='width:100px'>"+Liferay.Language.get('actual')+"</div></th>";
	ContentHTML+="		</tr>";
	ContentHTML+="	</thead>";
	ContentHTML+="	<tbody>";
	ContentHTML+="		<tr>";
	...
	ContentHTML+="		</tr>";
	ContentHTML+="		<tr>";
	ContentHTML+="			<td>"+Liferay.Language.get('percent-target')+"</td>";
	ContentHTML+="			<td colspan='2'><div id='perTarget-Item-"+item+"-Org-"+data['org_code']+"' class='sparkline'></div></td>";
	ContentHTML+="		</tr>";
	ContentHTML+="		<tr>";
	ContentHTML+="			<td>"+Liferay.Language.get('percent-forecast')+"</td>";
	 ...
	 $.each(data,function(index,indexEntry){
	  ...
	  htmlData3+="<tr>";
	   ...
	   if(indexEntry2['org_id']==org){
	    ...
	    htmlData2+="<thead>";
	    htmlData2+="<tr>";
	    htmlData2+="<th><div class='fontBold ' style='min-width:102px'>"+Liferay.Language.get('target')+"</div></th>";
	    htmlData2+="<th><div class='fontBold '  style='min-width:100px'>"+Liferay.Language.get('forecast')+"</div></th>";
	    htmlData2+="<th><div class='fontBold ' style='min-width:100px'>"+Liferay.Language.get('actual')+"</div></th>";
	      htmlData2+="</tr>";
	     htmlData2+="</thead>";
	     htmlData2+="<tbody>";
	      htmlData2+="<tr>";
	    ...
	    htmlData3+="<thead>";
	     htmlData3+="<tr>";
	      htmlData3+="<th><div class='fontBold ' style='min-width:102px;'>"+Liferay.Language.get('target')+"</div></th>";
	      htmlData3+="<th><div class='fontBold ' style='min-width:100px;'>"+Liferay.Language.get('forecast')+"</div></th>";
	      htmlData3+="<th><div class='fontBold ' style='min-width:100px;'>"+Liferay.Language.get('actual')+"</div></th>";
	      htmlData3+="</tr>";
	    htmlData3+="</thead>";
	     htmlData3+="<tbody>";
	      htmlData3+="<tr>";
	...
	var username = $('#user_portlet').val();
	 ...
	 if(username!="" && username!=null & username!=[] && username!=undefined ){
	 	...
	 	$("#btnSearchAdvance").click(function(){
			...
			var app_level_ = ($("#app_type").val() == "1") ? $("#AppraisalOrgLevel").val() : $("#AppraisalEmpLevel").val();
			searchAdvanceFn(
					$("#year").val(),
					$("#period").val(),
					app_level_,
	 	...
	 	if($("#get_sending_status").val() == "true" && $("#get_sending_status").val() != null){
			...
			$("#year").change(function(){$("#period").html(generateDropDownList(restfulURL+"/"+serviceName+"/public/dashboard/period_list","POST",{"appraisal_year":$("#year").val()}));});
			$("#apprasiaLevel").change(function(){$("#organization").html(generateDropDownList(restfulURL+"/"+serviceName+"/public/dashboard/org_list","POST",{"appraisal_level":$("#apprasiaLevel").val()}));$("#organization").change();});
			$("#organization").change(function(){$("#kpi").html((generateDropDownList(restfulURL+"/"+serviceName+"/public/dashboard/kpi_list","POST",{"appraisal_level":$("#apprasiaLevel").val(),"org_id":$("#organization").val(),"emp_id":$("#emp_name_id").val(),"appraisal_type_id":$("#app_type").val()})));});
			*/
			...
			// Change on #app_type for create #AppraisalEmpLevel and #apprasiaEmpLevel
