 ...
 $(document).ready(function(){
	var username = $('#user_portlet').val();
	 ...
	 if(username!="" && username!=null & username!=[] && username!=undefined ){
		...
		$("#apprasiaLevelOrg").html(generateDropDownList(restfulURL+"/"+serviceName+"/public/report/al_list_org","GET",{"level_id":$("#apprasiaLevel").val()},"All"));
		...
		$("#apprasiaLevel").change(function(){$("#apprasiaLevelOrg").html(generateDropDownList(restfulURL+"/"+serviceName+"/public/report/al_list_org","get",{"level_id":$("#apprasiaLevel").val()},"All"));$("#apprasiaLevelOrg").change();});
