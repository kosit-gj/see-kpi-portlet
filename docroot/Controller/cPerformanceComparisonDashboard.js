...
var genTableChartLine = function(data){
	...
	$.each(data['categories_table'],function(index,indexEntry){
		$.each(indexEntry['category'],function(index,indexEntry1){
			...
			$("#head-bar").text($('.lt-performance-by-employee').val()+" : "+indexEntry1['label']);  //get header bar chart
...
var genTableKPI = function(data){
	var name_score_achievement = '';
if(data['name_score_achievement'] == 'Score')
	name_score_achievement = $('.lt-score').val();
else
	name_score_achievement = $('.lt-percent-achievement').val();
...
var htmlTable = "";
	...
	htmlTable += "<th style='width: 230px;'>"+$('.lt-perspective').val()+"</th>";
	htmlTable += "<th>"+$('.lt-kpi-name').val()+"</th>";   
	htmlTable += "<th style='text-align: right;'>"+$('.lt-target').val()+"</th>"; 
	htmlTable += "<th>"+$('.lt-uom').val()+"</th>";
	htmlTable += "<th style='text-align: right;'>"+$('.lt-actual').val()+"</th>";  
	htmlTable += "<th style='text-align: right;'>"+name_score_achievement+"</th>";  
	htmlTable += "<th style='text-align: right;'>"+$('.lt-percent-weight').val()+"</th>"; 
	htmlTable += "<th style='text-align: right;'>"+$('.lt-weight-score').val()+"</th>";  
	htmlTable += "</tr>";
	htmlTable += "</thead>";
	htmlTable += "<tbody>";
...
var generateChartbar2D = function(id){  //chart bar by Daris
   ...
   if(id){ $("#head-bar-input").val(id); $("#head-bar").text($('.lt-performance-by-employee').val()+" : "+$("#"+id).text());}
