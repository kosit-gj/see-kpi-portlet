	    ...
	    $("#btnSearch").click(function(){
	      ...
	      if ($("#appraisalType").val() == 1) {
		        ...
		        if (is_all_employee == 0) {
		        	...
		        	dropDrowPositionFn();
		        	dropDrowIndividualOrgLevelFn(cMain_level_id);
		        }
		        else {
		        	dropDrowIndividualOrgLevelFn($("#AppraisalEmpLevel").val());
		        }
...
var htmlTable = "";
	...
	htmlTable += "<thead>";
	htmlTable += "<tr>";
	htmlTable += "<th style='width: 10px;'> <button class='btn btn-link' id='item-all' onclick='slidRowTable(\"item-all\")' type='button' style='color: #000000; padding: 0px; border-width: 0px;'><i class='icon-plus'></i></button></th>";
	htmlTable += "<th style='width: 230px;'>Perspective</th>";
	htmlTable += "<th style='width: 300px;'>KPI Name</th>";
	htmlTable += "<th style='text-align: right; width: 50px;'>Target</th>";
	htmlTable += "<th style='width: 50px;'>UOM</th>";
	htmlTable += "<th style='text-align: right; width: 50px;'>Actual</th>";
	htmlTable += "<th style='text-align: right; width: 50px;'>"+data['name_score_achievement']+"</th>";
	htmlTable += "<th style='text-align: right; width: 60px;'>%Weight</th>";
	htmlTable += "<th style='text-align: right; width: 90px;'>Weight Score</th>";
	htmlTable += "</tr>";
	htmlTable += "</thead>";
	htmlTable += "<tbody>";
...
var color = 'tr-color-1';
	$.each(data['items'],function(index,indexEntry){
		...
		htmlTable += "<td class='OverFlow'>"+indexEntry['perspective_name']+"</td>";
		htmlTable += "<td class='OverFlow'>"+indexEntry['item_name']+"</td>";
		...
		$.each(indexEntry['detail'],function(index,indexEntryDetail){
			...
			htmlTable += "<td></td>";
			htmlTable += "<td class='OverFlow'>"+indexEntryDetail['appraisal_period_desc']+"</td>";
			htmlTable += "<td class='OverFlow'>"+indexEntryDetail['item_name']+"</td>";
