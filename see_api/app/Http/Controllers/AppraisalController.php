...
class AppraisalController extends Controller
{
	...
	public function show(Request $request, $emp_result_id)
	{
		...
		$items = DB::select("
			select b.item_name, b.structure_id, c.structure_name, d.form_id, d.app_url, c.nof_target_score, a.*, e.perspective_name, a.weigh_score, f.weigh_score total_weigh_score, a.weight_percent, g.weight_percent total_weight_percent, al.no_weight,
			if(ifnull(a.target_value,0) = 0,0,(ifnull(a.actual_value,0)/a.target_value)*100) achievement, h.result_threshold_group_id
